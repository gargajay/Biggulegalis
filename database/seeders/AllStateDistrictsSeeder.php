...
use App\Models\DistrictBarAssociation; // Make sure to import the DistrictBarAssociation model

class AllStateDistrictsSeeder extends Seeder
{
    public function run()
    {
        $statesWithDistricts = [
            ...
            ['name' => 'Andhra Pradesh', 'districts' => [
                'Anantapur', 'Chittoor', 'East Godavari', 'Guntur', 'Krishna', 'Kurnool', 'Nellore', 'Prakasam', 'Srikakulam', 'Visakhapatnam', 'Vizianagaram', 'West Godavari', 'Y.S.R. Kadapa',
            ]],
            ...
            ['name' => 'Karnataka', 'districts' => [
                'Bagalkot', 'Ballari', 'Belagavi', 'Bengaluru Rural', 'Bengaluru Urban', 'Bidar', 'Chamarajanagara', 'Chikkaballapur', 'Chikkamagaluru', 'Chitradurga', 'Dakshina Kannada', 'Davanagere', 'Dharwad', 'Gadag', 'Hassan', 'Haveri', 'Kalaburagi', 'Kodagu', 'Kolar', 'Koppal', 'Mandya', 'Mysuru', 'Raichur', 'Ramanagara', 'Shivamogga', 'Tumakuru', 'Udupi', 'Uttara Kannada', 'Vijayapura', 'Yadgir',
            ]],
            ...
            ['name' => 'Mizoram', 'districts' => [
                'Aizawl', 'Champhai', 'Hnahthial', 'Khawzawl', 'Lawngtlai', 'Lunglei', 'Mamit', 'Saiha', 'Serchhip',
            ]],
